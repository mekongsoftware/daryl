...
.constant('AppSettings', {
    ...
    */
    ...
    LeftMenu: [
        { state: 'order-main', name: 'Overview', accessLevel: 1 },
        { state: 'order-list-cashier({tableId: null})', name: 'Pending Orders', accessLevel: 1 },
        { state: 'order-list-kitchen', name: 'Kitchen', accessLevel: 1 },
        
        //{ state: 'test', name: 'Test', accessLevel: 0 },
        /*
        {
        ...
        
        {
            ...
            subMenu: [
                ...
                { state: 'product', name: 'Product', accessLevel: 1 },
                { state: 'addon', name: 'Addon', accessLevel: 1 },
                { state: 'table', name: 'Table', accessLevel: 1 },
                { state: '-', name: 'separator', accessLevel: 1 },
    ...
    RightMenu: [
        { state: 'setup', name: 'Setup*', accessLevel: 1 },
        { state: 'login', name: 'Login', accessLevel: -1 },             // show only if user is not logged in (accessLevel -1)
        { state: 'logout', name: 'Logout', accessLevel: 1 }, //, onClick: "logOut()" },
        //{ state: 'signup', name: 'Signup', accessLevel: -1 },
        //{ state: 'about', name: 'About', accessLevel: 0 },
    ]
})